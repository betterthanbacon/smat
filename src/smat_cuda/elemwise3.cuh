...
struct execute_elemwise3_typed {
	...
	template <typename T> struct logical { static void execute(opcode_t opcode, const argument& a, const argument& b, const argument& c) { general<T,T,dtype2ctype(dt_logical)>::execute(opcode,a,b,c); } };
};
